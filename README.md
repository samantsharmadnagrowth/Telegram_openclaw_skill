# Openclaw Skill to Fetch Telegram Messages
...
This tool uses your personal Telegram API credentials. Avoid sharing your `apiId`, `apiHash`, or `session.txt` with anyone. And before running the code, add your `apiId`and `apiHash` in the fetch_tg.js file. Add this code to the Workspace folder in the OpenClaw source code.
